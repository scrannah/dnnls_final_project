...
class NewBackbone(nn.Module):
    ...
    def __init__(self, latent_dim=128, output_h=30, output_w=63):  # remember to calculate output w h
...
class NewVisualEncoder(nn.Module):
    ...
    def __init__(self, latent_dim=128, output_h=30, output_w=63):
...
class NewVisualDecoder(nn.Module):
    ...
    def __init__(self, latent_dim=128, output_h=30, output_w=63):
        ...
        self.imh = 240  # Image height TRANSFORM RESIZE
        self.imw = 500  # Image width
        self.flatten_dim = 64 * output_h * output_w
