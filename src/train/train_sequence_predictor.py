...
def train_sequence_predictor(
    ...
    for epoch in range(num_epochs):
        ...
        print( "----------------")
        mse_values, perplexity_values, bleu_values, crossmodal_values, ssim_values = validation( model, train_dataloader, device, tokenizer, criterion_images, criterion_text )
        ...
        print( "----------------")
        val_mse, val_perp, val_bleu, val_crossmodal, val_ssim = validation( model, val_dataloader, device, tokenizer, criterion_images, criterion_text )
